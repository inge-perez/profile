...
export const experiences: Experience[] = [
	...
	{
		title: 'Desarrollador Frontend  Sr. | Webmaster',
		description: 'Frontend | WEB UI | Freelancer',
		pubDate: new Date('Jun 01 2023'),
		tags: ['React', 'SCRUM', 'API REST', 'Git', 'Wordpress', 'NodeJS', 'Astro JS', 'Tailwind CSS', 'Azure']
	},
	{
		title: 'QA Analyst',
